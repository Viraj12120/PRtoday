...
async def test_orchestrator_run_success():
    with patch("pr_today.orchestrator.Github") as mock_github, patch(
        "pr_today.orchestrator.RiskEngine.analyze"
    ) as mock_analyze, patch(
        "pr_today.orchestrator.AIEngine.review", new_callable=AsyncMock
    ) as mock_review, patch(
        "pr_today.orchestrator.get_session"
    ) as mock_get_session, patch(
        "pr_today.orchestrator.httpx.AsyncClient"
    ) as mock_client:
